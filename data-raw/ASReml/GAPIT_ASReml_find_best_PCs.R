...
projectdir <- "/home/alice/Github/CDBNgenomics/data-raw/ASReml/GAPIT-model-selection/"
setwd(projectdir)

gapit_phe_asreml <- read.table(file = "/home/alice/Github/CDBNgenomics/data-raw/ASReml/ASReml_coefficients_GAPIT_2020-01-11.txt", head = TRUE)
