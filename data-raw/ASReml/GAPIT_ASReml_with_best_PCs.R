...
projectdir <- "/home/alice/Github/CDBNgenomics/data-raw/ASReml/GAPIT-0-PCs/"
setwd(projectdir)

gapit_phe_asreml <- read.table(file = "/home/alice/Github/CDBNgenomics/data-raw/ASReml/ASReml_coefficients_9_GAPIT_2020-01-11.txt", head = TRUE)
